...
?>
	<tr height="25px">
		<td><? echo($i + 1) ?></td>
		<td><? echo($row[$i][1]) ?></td>
		<td align="center"><a href="?page=categoriesedit&id=<? echo($row[$i][0]) ?>"><img src="css/edit.png" width="16" height="16" /></a></td>
		<td align="center"><a href="?page=categoriesdelete&id=<? echo($row[$i][0]) ?>"  onClick="return confirm('Do you want to delete <? echo($row[$i][1]) ?> catogry?');"><img src="css/delete.png" width="16" height="16" /></a></td>
    </tr>
<?
	}
?>
